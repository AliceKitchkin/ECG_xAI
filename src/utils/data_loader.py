...
# ------------------------------ CLASS ------------------------------
class EKGDataLoader:
    def __init__(self, data_path, sampling_frequency=100, task='superdiagnostic', output_folder='results/'):
    ...
    def load_ptbxl_data(self, min_samples=0):
        ...
        task = self.task
        outputfolder_for_mlb = os.path.join(os.path.dirname(datafolder), '../../results/mlb/')
